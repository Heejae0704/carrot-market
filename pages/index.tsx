  ...
  return (
    <div className="bg-slate-400 py-20 px-20 grid gap-10 min-h-screen">
      ...
      <div className="bg-white p-6 rounded-3xl shadow-xl">
        ...
        <button className="mt-5 bg-blue-500 text-white p-3 text-center rounded-xl w-3/4 mx-auto hover:bg-teal-500 hover:text-black active:bg-yellow-500 focus:text-red-500 block">
          Checkout
        </button>
      </div>
